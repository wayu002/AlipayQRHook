...
import wy.experiment.xposed.wechat.WeChatCracker;
...
public class MainIntercept implements IXposedHookLoadPackage {
    ...
    public void handleLoadPackage(XC_LoadPackage.LoadPackageParam lpparam) throws Throwable {
        if (!lpparam.packageName.equals(XPConstant.ALI_PACKAGE) && !lpparam.packageName.equals(XPConstant.WECAHT_PACKAGE)) {
            return;
        }
        ...
        }else if(lpparam.packageName.equals(XPConstant.WECAHT_PACKAGE) && lpparam.processName.equals(XPConstant.WECAHT_PACKAGE)){
            mCracker = WeChatCracker.instance();
        }
